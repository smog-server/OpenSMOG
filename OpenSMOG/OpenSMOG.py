        ...
        for iteraction in data[2]:
            ...
            if data[3]:
                ...
                if exlabel in self.bondedExclusions:
                    print(f"WARNING: Exclusion between atoms {int(index_i)+1} and {int(index_j)+1} is being generated by a contact, but it was also generated based on bonds. Will skip this exclusion, to avoid raising an exception later.")
