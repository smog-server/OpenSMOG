# Copyright (c) 2020,2021,2022 The Center for Theoretical Biological Physics (CTBP) - Rice University and Northeastern University
# This file is from the OpenSMOG project, released under the MIT License. 

R"""  
The :class:`~.OpenSMOG_Check` class provides routines for testing the installation of OpenSMOG.
"""
