...
OpenSMOGmod
========
OpenSMOGmod is a modified version of OpenSMOG v1.1.1. The modified version only differes in
...
Note: OpenSMOGmod is only intended for testing different models.
